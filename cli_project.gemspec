...
Gem::Specification.new do |spec|
  ...
  spec.authors       = ["'Dina Kendle'"]
  spec.email         = ["'dina.kendle@gmail.com'"]
  ...
  spec.homepage      = "https://github.com/DKendle/cli_project"
  spec.license       = "MIT"
  ...
  if spec.respond_to?(:metadata)
    ...
    spec.metadata["source_code_uri"] = "https://github.com/DKendle/cli_project"
    spec.metadata["changelog_uri"] = "https://github.com/DKendle/cli_project"
  else
